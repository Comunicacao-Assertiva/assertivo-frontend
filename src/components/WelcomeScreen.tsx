    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-5 py-10 text-center">
      ...
      <div className="mb-6 w-full max-w-sm rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-xs text-white/50 text-left space-y-1">
        ...
        <p>
          ...
          cada erro. Recarregam com o tempo!
        </p>
        <p>
        ...
        <p>
          ⛪ <span className="font-bold text-white/70">Contexto:</span>{" "}
          situações do ambiente eclesiástico.
        </p>
      </div>
      ...
      {(!hasSave || showNew) && (
        <div className="w-full max-w-sm">
          ...
          <input
            ...
            onKeyDown={(e) =>
              e.key === "Enter" && isValid && onStart(name.trim(), "igreja")
            }
          ...
          <button
            onClick={() => isValid && onStart(name.trim(), "igreja")}
            disabled={!isValid}
