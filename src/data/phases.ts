...
export const PHASES_DATA: Topic[] = [
  ...
  },
  {
    ...
    subPhases:[
      {
        id:'6-1', title:'Mensagens e E-mails',
        description:'A maioria dos conflitos digitais começa com mensagem mal interpretada.',
        items:[{
          id:'6-1-tip', type:'tip', icon:'✉️',
