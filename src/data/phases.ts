...
export const PHASES_DATA: Phase[] = [
        ...
        choices: [
          {
            ...
            type: "partial",
            feedback:
              "Razoável, mas falta clareza: qual o novo horário? Por quê mudou? Mensagens vagas geram confusão no grupo.",
          },
          {
            id: "1-1-b",
            text: '"Irmãos! O culto será às 19h (era 18h). Motivo: compromisso pastoral. Contamos com todos! Dúvidas, me chame."',
            points: 667,
            type: "correct",
            feedback:
              "Assertivo! Você foi claro sobre o que mudou, por quê e como tirar dúvidas. Exatamente o que o grupo precisava.",
          },
          {
            id: "1-1-c",
            ...
            type: "wrong",
            feedback:
              "Essa mensagem gera mais insegurança do que clareza. Uma comunicação assertiva transmite certeza, não dúvida.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            id: "1-2-a",
            text: '"Você é sempre o último! Isso é falta de respeito com todo mundo!"',
            points: 0,
            type: "wrong",
            feedback:
              "Agressivo e generalizante. Atacar a pessoa ao invés do comportamento prejudica o relacionamento.",
          },
          {
            id: "1-2-b",
            ...
            type: "partial",
            feedback:
              "Evitar o conflito pode parecer paz, mas o problema continua. A assertividade exige coragem para abordar com cuidado.",
          },
          {
            id: "1-2-c",
            ...
            type: "correct",
            feedback:
              "Excelente! Você descreveu o comportamento sem julgar, abriu espaço para escuta e ofereceu ajuda. Assertividade com empatia.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            id: "1-3-a",
            text: "Fala tão rápido e nervoso que mistura vários recados — ninguém entende direito.",
            points: 0,
            type: "wrong",
            feedback:
              "A ansiedade atropelou a mensagem. A comunicação assertiva exige preparação antes de falar.",
          },
          {
            id: "1-3-b",
    ...
    scenarios: [
      {
        ...
        choices: [
          ...
          },
          {
            ...
            type: "wrong",
            feedback:
              "Redirecionar para si mesmo invalida a experiência do outro. Escuta ativa exige deixar o protagonismo com quem fala.",
          },
          {
            id: "2-1-c",
            ...
            type: "correct",
            feedback:
              "Isso é escuta ativa! Você deu ao membro o que ele mais precisava: ser verdadeiramente ouvido.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            ...
            type: "wrong",
            feedback:
              "Interromper cria um ambiente inseguro. Mesmo discordando, ouça até o fim.",
          },
          {
            id: "2-2-b",
          ...
          },
          {
            ...
            type: "correct",
            feedback:
              "Brilhante! Você ouviu, reconheceu e fez uma pergunta construtiva. Isso valoriza e engaja.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            ...
            type: "wrong",
            feedback:
              "A forma importa. Corrigir assim em público gera vergonha e fecha o coração do outro.",
          },
          {
            id: "2-3-b",
            ...
            type: "partial",
            feedback:
              "A paz artificial não edifica. A assertividade pede honestidade — com amor.",
          },
          {
            id: "2-3-c",
            ...
            type: "correct",
            feedback:
              "Você valorizou a contribuição antes de apresentar a sua. Isso é falar a verdade em amor (Ef 4:15).",
          },
        ],
      },
    ],
        ...
        choices: [
          {
            ...
            type: "partial",
            feedback:
              "Aceitar para não desapontar cria expectativas não cumpridas. Um não honesto prejudica menos.",
          },
          {
            id: "3-1-b",
            ...
            type: "correct",
            feedback:
              "Impecável! Honesto, com boa vontade e alternativa. Isso é assertividade com integridade.",
          },
          {
            id: "3-1-c",
            ...
            type: "wrong",
            feedback:
              "A pior das opções: gera frustração e destrói a confiança. Um não claro é sempre melhor que um sim vazio.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            ...
            type: "wrong",
            feedback:
              "Reagir emocionalmente escala o conflito e prejudica sua credibilidade. Assertividade exige autocontrole.",
          },
          {
            id: "3-2-b",
            ...
            type: "partial",
            feedback:
              "O ressentimento guardado corrói os relacionamentos. Meia solução.",
          },
          {
            id: "3-2-c",
            ...
            type: "correct",
            feedback:
              "Maturidade em ação! Você se autorregulou e escolheu o diálogo privado — forma mais assertiva de resolver.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            ...
            type: "wrong",
            feedback:
              "Negar responsabilidade corrói a confiança. Líderes que assumem erros inspiram mais.",
          },
          {
            id: "3-3-b",
          ...
          },
          {
            ...
            type: "correct",
            feedback:
              "Responsabilidade com humildade! Assumir erros sem defensividade é marca de liderança madura.",
          },
        ],
      },
    ],
    ...
    scenarios: [
      {
        ...
        choices: [
          ...
          },
          {
            ...
            type: "partial",
            feedback:
              "Pode deixar feridas abertas que comprometem a equipe. Omitir-se como líder tem custo.",
          },
          {
            id: "4-1-c",
            ...
            type: "correct",
            feedback:
              "Mediação exemplar! Ouvir cada parte separadamente garante segurança e honestidade no diálogo.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            ...
            type: "wrong",
            feedback:
              "Voz com voz cria caos. Quem mantém a calma tem poder de influência muito maior.",
          },
          {
            id: "4-2-b",
            ...
            type: "partial",
            feedback:
              "O silêncio evita escalamento, mas uma intervenção calma e firme seria mais eficaz.",
          },
          {
            id: "4-2-c",
            ...
            type: "correct",
            feedback:
              "Liderança comunicacional! Você desescalou, reafirmou o propósito comum e propôs mudança de postura.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            ...
            type: "wrong",
            feedback:
              "Triangulação — falar para liderados o que deveria ir à liderança. Destrói confiança e envenena o ambiente.",
          },
          {
            id: "4-3-b",
            ...
            type: "partial",
            feedback:
              "Se sua perspectiva pode contribuir, a assertividade pede que você a compartilhe respeitosamente.",
          },
          {
            id: "4-3-c",
            ...
            type: "correct",
            feedback:
              "Levar a discordância diretamente a quem decidiu, com respeito e abertura, é o caminho assertivo.",
          },
        ],
      },
    ],
  },
  {
    ...
    description:
      "Uma comunidade assertiva é aquela onde todos se sentem seguros para ser quem são e expressar o que sentem.",
        ...
        choices: [
          {
            ...
            type: "partial",
            feedback:
              "Acolhimento genuíno vem de qualquer membro — não precisa de cargo.",
          },
          {
            id: "5-1-b",
            ...
            type: "wrong",
            feedback:
              "O novo membro vai embora sem se sentir pertencente. Pequenos gestos fazem toda a diferença.",
          },
          {
            id: "5-1-c",
            ...
            type: "correct",
            feedback:
              "Isso é criar pertencimento! Um simples gesto pode mudar a vida dessa pessoa.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            ...
            type: "wrong",
            feedback:
              "O afastamento silencioso é quase sempre um pedido de atenção não verbalizado. Esperar contradiz o cuidado pastoral.",
          },
          {
            id: "5-2-b",
            ...
            type: "partial",
            feedback:
              "Melhor do que ignorar, mas o tom pode minimizar algo sério. Um contato mais cuidadoso demonstra mais genuinidade.",
          },
          {
            id: "5-2-c",
            ...
            type: "correct",
            feedback:
              "Perfeito! Cuidado genuíno, espaço sem pressão, disponibilidade. Comunicação assertiva a serviço do cuidado pastoral.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            ...
            type: "partial",
            feedback:
              "Falsa concordância pode validar algo que precisa de aprofundamento ou correção.",
          },
          {
            id: "5-3-b",
            ...
            type: "correct",
            feedback:
              "Magistral! Você valorizou a coragem de quem falou e abriu espaço para diálogo saudável.",
          },
          {
            id: "5-3-c",
            ...
            type: "wrong",
            feedback:
              "Ignorar perde uma oportunidade de diálogo genuíno. Ambiente seguro exige disposição de abordar o difícil.",
          },
        ],
      },
    ],
